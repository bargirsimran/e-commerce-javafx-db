...
public class UserUpdatedViewer {
public static void show() throws IOException {
		
		URL fxmlUrl;
		
		fxmlUrl=Paths.get("C:\\Users\\user\\eclipse-workspace\\EcommerceJavaFxDB\\src\\EcommerceUpdateUser\\UserUpdatedScreen.fxml").toUri().toURL();
